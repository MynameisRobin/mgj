<template>
	<li class="pop_model_item" v-loading="singleLoding">
		<div v-if="!isEdit">
			<div class="textDiv planName">
				<div v-if="itemBig.name" :title="itemBig.name">
					<PlanType :type="itemBig.isBonus"></PlanType>
				...
				<div>
					<el-scrollbar wrap-class="default-scrollbar__wrap" view-class="default-scrollbar__view" 
						...
						<div v-for="(itemA, keyA) in itemBig.shopsList " :key="keyA" :title="itemA.osname">
							...
							<el-popover v-if="itemA.employees && itemA.employees.length"
								placement="right"
								trigger="hover">
			...
			<div class="textDiv">
				<!-- <el-checkbox disabled :checked="itemBig.isBonus == 1 ? true : false" v-model="itemBig.isBonus">奖励</el-checkbox> -->
				<el-checkbox-group v-model="checkBoxG" class="bonus_checkbox_group">
					<el-checkbox disabled :label="itemBig.isBonus">奖励</el-checkbox>
				</el-checkbox-group>
			</div>
			<div class="textDiv">
				<div class="operation">
		...
		<div v-else>
			<div class="textDiv planName">
				<PlanType :type="editVm.isBonus || 0"></PlanType>
			...
			<div v-if="editVm.id" :class="{'textDiv': true, 'storeList' : true, 'isEdit': isEdit}" @click="distributionFun(editVm)">
				<div>
					...
					<div v-if="editVm.shopsList && editVm.shopsList.length > 0 && editVm.shopsList.length < 2" v-for="(itemA, keyA) in editVm.shopsList " :key="keyA">
						{{itemA.osname | cutString(8)}}
						<el-popover
							placement="right"
							trigger="hover">
			...
			<div class="textDiv">
				<el-checkbox :disabled="editVm.shopsList && editVm.shopsList.length > 0" 
					:checked="editVm.isBonus ? true : false" v-model="editVm.isBonus">奖励</el-checkbox>
			</div>
			<div class="textDiv">
				<div class="operation">
