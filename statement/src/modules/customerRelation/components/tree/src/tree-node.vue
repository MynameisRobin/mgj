<template>
	<div 
		...
		<div class="am_tree_node-content"
			...
			<span class="am_tree_node-label" :class="{'is_auxiliary': node.data.level === 2 && node.data.softgenre === 3}" :title="node.data[tree.props.label]">{{ node.data[tree.props.label] | cutString(16) }}</span>
...
<style>
	...
	.am_tree_node-label.is_auxiliary {
		color: #67c23a;
	}
	.am_tree_node-check_all {
		opacity: 0;
